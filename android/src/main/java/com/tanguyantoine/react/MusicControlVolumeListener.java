...
public class MusicControlVolumeListener extends VolumeProviderCompat {
    ...
    MusicControlVolumeListener(ReactApplicationContext context, MusicControlEventEmitter emitter, boolean changeable,
    ...
    public MusicControlVolumeListener create(Boolean changeable, Integer maxVolume, Integer currentVolume) {
        ...
        if (changeable == isChangeable() && maxVolume == getMaxVolume())
            return this;
